...
import { faSearch, faKeyboard, faArrowUp } from '@fortawesome/free-solid-svg-icons'
...
export default function SearchPage({ allPosts }: SearchPageProps) {
  ...
  return (
    <div className="search-page-container w-full max-w-4xl mx-auto px-4 space-y-6">
      ...
      <Card className={cn(
        ...
        <CardHeader className="pb-4">
          <div className="flex items-center gap-2 mb-4">
            <Fa icon={faSearch} className="text-primary text-xl" />
          ...
          <div className="space-y-4">
            <p className="text-muted-foreground leading-relaxed">
              포스트, 태그, 카테고리를 검색해보세요. 더 빠른 검색을 위해 <strong>Command Palette</strong>를 사용해보세요!
            </p>
            ...
            <div className={cn(
              ...
              <div className="flex items-center gap-3">
                <div className="p-2 rounded-md bg-primary/20">
                  <Fa icon={faKeyboard} className="text-primary text-sm" />
                </div>
                <div>
